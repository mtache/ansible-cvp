...
class CvFactsTools():
    ...
    def facts(self, scope: List[str] = ['devices', 'configlets']):   # noqa # pylint: disable=dangerous-default-value
        """
        ...
        scope : List[str], optional
            List of elements to get from Cloudivion server, by default ['devices', 'configlets']
